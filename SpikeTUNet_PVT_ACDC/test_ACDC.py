...
def inference(args, model, test_save_path=None):
    db_test = ACDCdataset(base_dir=args.volume_path, split="test", list_dir=args.list_dir)
    ...
    #logging.info('class 0: %f class 1: %f class 2: %f class 3: %f ' % (metric0/cnt0, metric1/cnt1, metric2/cnt2, metric3/cnt3))
...
if __name__ == "__main__":
    ...
    #args.Dataset = dataset_config[dataset_name]['ACDC']
